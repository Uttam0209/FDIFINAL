...
<<<<<<< HEAD
        public DataTable RetriveGridViewCompany(string ID, string Factory,string unit,string Purpose)
=======
...
<<<<<<< HEAD
                    ...
                    db.AddInParameter(cmd, "@FactoryRefNo", DbType.String, Factory);

                    db.AddInParameter(cmd, "@UnitRefNo", DbType.String, unit);
=======
