<%@ Page Title="" Language="C#" MasterPageFile="~/Vendor/VendorMaster2.master" AutoEventWireup="true" CodeFile="V_Add_User.aspx.cs" Inherits="Vendor_V_Add_User" %>
...
<div class="col-md-6 col-sm-6">
    <asp:TextBox ID="NolOffName" runat="server" class="form-control" placeholder="User Name *"></asp:TextBox>
</div>
</div>
<div class="field item form-group">
<label class="col-form-label col-md-3 col-sm-3  label-align">User email:<span class="required">*</span></label>
<div class="col-md-6 col-sm-6">
 <asp:TextBox ID="VEmailID" runat="server" class="form-control" placeholder="User Email ID *"></asp:TextBox>
...
<div class="field item form-group">
<label class="col-form-label col-md-3 col-sm-3  label-align">User Contact No. <span class="required">*</span></label>
<div class="col-md-6 col-sm-6">
<asp:TextBox ID="VmobileNO" runat="server" class="form-control" placeholder="User Mobile NO *" onkeypress="return isNumberKey(event)"></asp:TextBox>
</div>
</div>
<div class="field item form-group">
<label class="col-form-label col-md-3 col-sm-3  label-align">User Registered Office Address <span class="required">*</span></label>
<div class="col-md-6 col-sm-6">
<asp:TextBox ID="NolOffADDRE1" runat="server" class="form-control" placeholder="User Registered Office Address *"></asp:TextBox></div>
</div>
<div class="field item form-group">
<label class="col-form-label col-md-3 col-sm-3  label-align">User Registered Office Address 2 <span class="required">*</span></label>
<div class="col-md-6 col-sm-6">
<asp:TextBox ID="NolOffADDRE2" runat="server" class="form-control" placeholder="User Registered Office Address2 *"></asp:TextBox></div>
</div>
...
<asp:TextBox ID="sugpin" runat="server" class="form-control" placeholder="Pincode *" onkeypress="return isNumberKey(event)"></asp:TextBox>
    ...
    <div class="field item form-group">
<label class="col-form-label col-md-3 col-sm-3  label-align">Company ID <span class="required">*</span></label>
<div class="col-md-6 col-sm-6">
<asp:FileUpload ID="FileUpload1" runat="server" class="form-control" /></div>
</div>

    <div class="field item form-group">
<label class="col-form-label col-md-3 col-sm-3  label-align">Government ID Card . <span class="required">*</span></label>
<div class="col-md-6 col-sm-6">
...
<div class="col-md-6 offset-md-3">
    <asp:Button class="btn btn-primary" ID="Button2" OnClick="profileMigrat" Text="Add User" runat="server" OnClientClick= "return validate();"/>
