<%@ Page Title="" Language="C#" MasterPageFile="~/Vendor/VendorMaster2.master" AutoEventWireup="true" CodeFile="V_AddNewVendor.aspx.cs" Inherits="Vendor_V_AddNewVendor" %>
...
<div class="x_content">
<form>
<span class="section">Vendor</span>
<div class="field item form-group">
<label class="col-form-label col-md-3 col-sm-3  label-align">REGISTRATION CATEGORY *<span class="required">*</span></label>
<div class="col-md-6 col-sm-6">
    <asp:TextBox ID="TextBox1" runat="server" class="form-control" placeholder="MANUFACTURER *" ReadOnly="true"></asp:TextBox>
</div>
</div>
    <div class="field item form-group">
<label class="col-form-label col-md-3 col-sm-3  label-align">Vendor Name<span class="required">*</span></label>
<div class="col-md-6 col-sm-6">
    <asp:TextBox ID="NolOffName" runat="server" class="form-control" placeholder="Vendor Name *"></asp:TextBox>
</div>
</div>
<div class="field item form-group">
<label class="col-form-label col-md-3 col-sm-3  label-align">Vendor email:<span class="required">*</span></label>
<div class="col-md-6 col-sm-6">
 <asp:TextBox ID="VEmailID" runat="server" class="form-control" placeholder="Vendor Email ID *"></asp:TextBox>
...
<div class="field item form-group">
<label class="col-form-label col-md-3 col-sm-3  label-align">Vendor Contact No. <span class="required">*</span></label>
<div class="col-md-6 col-sm-6">
...
<div class="field item form-group">
<label class="col-form-label col-md-3 col-sm-3  label-align">Vendor Registered Office Address <span class="required">*</span></label>
<div class="col-md-6 col-sm-6">
<asp:TextBox ID="NolOffADDRE1" runat="server" class="form-control" placeholder="Vendor Registered Office Address *"></asp:TextBox></div>
</div>
<div class="field item form-group">
<label class="col-form-label col-md-3 col-sm-3  label-align">Vendor Registered Office Address 2 <span class="required">*</span></label>
<div class="col-md-6 col-sm-6">
<asp:TextBox ID="NolOffADDRE2" runat="server" class="form-control" placeholder="Vendor Registered Office Address2 *"></asp:TextBox></div>
</div>
...
<div class="col-md-6 offset-md-3">
    <asp:Button class="btn btn-primary" ID="Button2" OnClick="profileMigrat" Text="Add New Vendor" runat="server" OnClientClick= "return validate();"/>
