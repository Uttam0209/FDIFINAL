...
public partial class Vendor_V_User_List : System.Web.UI.Page
{
    ...
    protected void GetProfileDetail()
    {
       ...
       dt = GetvendorIDDetail();
        ...
        {
            GridView1.DataSource = DtGetRegisVendor1;
            GridView1.DataBind();
            GridView2.DataSource = DtGetRegisVendor1;
            GridView2.DataBind();
            GridView3.DataSource = DtGetRegisVendor1;
            GridView3.DataBind();
