<%@ Page Language="C#" AutoEventWireup="true" CodeFile="confirmEmailupdation.aspx.cs" Inherits="Vendor_confirmEmailupdation" %>
            ...
            <nav class="navbar" role="navigation">
                <div class="navbar-header">
                    <a class="navbar-brand" href="javascript:void(0)"><i class="fa fa-list btn-nav-toggle-responsive text-white"></i>
                        <span class="main-logo" title="Department of Defense Product">RAKSHA UDYOGE MITRA PORTAL</span>
                    </a>
                </div>
            </nav>
            <div class="container col-lg-offset-4">
                <div class="col-sm-6 col-lg-6">
                    <asp:Panel ID="panstep1" runat="server">
                        <h3>Please click The below button for confirmation</h3>
                        ...
                        <asp:Button ID="btnsubmit" runat="server" CssClass="btn btn-primary pull-right" Text="Update your Email and Passowrd" OnClick="btnsubmit_Click" />
