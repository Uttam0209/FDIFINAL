<%@ Page Language="C#" AutoEventWireup="true" CodeFile="confirmProfileMigration.aspx.cs" Inherits="Vendor_confirmProfileMigration" %>
            ...
            <div class="container col-lg-offset-4">
                <div class="col-sm-6 col-lg-6">
                    <asp:Panel ID="panstep1" runat="server">
                        <h3>Create Password Your Password</h3>
                        <p>Please provide all required details Migrate Profile</p>
