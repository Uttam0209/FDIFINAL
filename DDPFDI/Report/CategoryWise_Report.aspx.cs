...
public partial class Report_CategoryWise_Report : System.Web.UI.Page
{
    #region Pagevariable
    ...
    {
        ddlcompany.Items.Insert(0, "Select");
        DtGrid = Lo.MaketwoReport("", "", "", "", "CategoryWaiseReport");
    ...
    protected void BindIndiCategory()
    {
        ...
        {
            Co.FillDropdownlist(DDL_Cat, DtMasterCategroy, "SCategoryName", "SCategoryID");
    ...
    protected void BindFinancialYear()
    {
        ...
        {
            Co.FillDropdownlist(DDLYear, MasterFinancialYear, "FY", "FYID");
    ...
    protected string Dvinsert(string sortExpression = null)
    {
        ...
        if (DDL_Cat.SelectedItem.Text != "Select")
        {
            dr = insert.NewRow();
            dr["Column"] = "PurposeofProcurement" + "=";
            dr["Value"] = "'" + DDL_Cat.SelectedItem.Value + "'";
            insert.Rows.Add(dr);
        }
        if (DDLYear.SelectedItem.Text != "Select")
        {
            ...
            dr["Value"] = "'" + DDLYear.SelectedItem.Value + "'";
            insert.Rows.Add(dr);
        }
    ...
    {
        Report_CategoryWise_Report u = new Report_CategoryWise_Report();
