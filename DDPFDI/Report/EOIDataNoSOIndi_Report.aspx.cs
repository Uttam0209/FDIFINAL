...
public partial class Report_EOIDataNoSOIndi_Report : System.Web.UI.Page
{
    #region Pagevariable
    ...
    {
        ddlcompany.Items.Insert(0, "Select");
        DtGrid = Lo.NewRetriveFilterCode("eoinoso", "", "", "", "", 0, 0, 0);
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            objExport.ExportDetails(searchdt, iColumns, RKLib.ExportData.Export.ExportFormat.Excel, "EOI_DATA_NO_SO_OR_INDIG.xls");
        }
        catch (Exception ex)
        {
        }
