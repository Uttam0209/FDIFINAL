<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SHQfrmUpdateProductBulkExcel.aspx.cs" Inherits="SHQfrmUpdateProductBulkExcel" MasterPageFile="~/Admin/MasterPage.master" %>
                    ...
                    <div class="section-pannel">
                        <div class="row">
                            ...
                            <asp:DropDownList ID="ddlcompany" runat="server" CssClass="form-control" AutoPostBack="true" >
                                ...
                                <asp:ListItem  Value="C0023" Text="SHQ(ARMY)">
                                </asp:ListItem>
                                 <asp:ListItem  Value="C0024" Text="SHQ(NAVY)">
                                </asp:ListItem>
                                 <asp:ListItem  Value="C0025" Text="SHQ(AIR FORCE)">
                                </asp:ListItem>
                            </asp:DropDownList>
                                    </div>
                                </div>
                                ...
                                <div runat="server" id="divuploadsection">
                                    ...
                                    <div>
                                       ...
                                       <%-- <p>2. All mandatory dropdown like (NSN GROUP,NSN GROUP CLASS,ITEM CODE,HS CODE etc) should be correct and as per master given data in website.</p>--%>
                                        ...
                                        <p>2. Headers are given in sample excel, please add rows as per your data.</p>
                                        <p>
                                            3.Always check excel sheet name should be Sheet1.
                                        </p>
                                    </div>
                                </div>
                                <div class="clearfix mt10"></div>
