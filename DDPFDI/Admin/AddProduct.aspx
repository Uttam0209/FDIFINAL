                    ...
                    <div class="col-md-12">
                        <div class="add-profile">
                            <form>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <asp:Button runat="server" ID="btnclear" Text="Cancel" class="btn btn-danger pull-right" OnClick="btnclear_Click" />
                                        <asp:Button ID="btnsave" Text="Save & Next" class="btn btn-primary pull-right" runat="server" OnClick="btnsave_Click" />
                                    </div>
                                </div>
                            </form>
                        </div>
