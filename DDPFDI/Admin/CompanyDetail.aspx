                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="fdi-add-content">
                                        ...
                                        <div class="indiacompanydetails fade" id="fdistep3">
                                        ...
                                        <div class="indiacompanydetails fade" id="fdistep4">
                                        ...
                                        <div class="indiacompanydetails fade" id="fdistep5">
                                                                ...
                                                                <label>
                                                                    Are You resitered with Start up India ?
                                                                        <label style="margin-right: 20px; margin-left: 10px;">
                                                                            <input type="checkbox" name="startup">Yes</label><label><input type="checkbox" name="startup">No</label></label>
                                                            </div>
                                                        </form>
