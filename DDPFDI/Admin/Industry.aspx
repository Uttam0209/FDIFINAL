      ...
      <div class="sideBg">
            <div class="row">
                <div class="col-md-12 padding_0">
                    ...
                    <div id="ContentPlaceHolder1_divHeadPage"><ul class="breadcrumb"><li class=""><span>Company Master </span></li><li class=""><span> Add </span></li><li class=""><span> Company</span></li></ul></div>
                </div>
            </div>
          <div class="tabing-section">
                <ul class="nav nav-tabs">
                    <li><a data-toggle="tab" href="#gi">General Information</a></li>
                    <li><a data-toggle="tab" href="#pro">Profile</a></li>
                    <li><a data-toggle="tab" href="#spez">Specialization</a></li>
                    <li class="active"><a data-toggle="tab" href="#pd">Project Details</a></li>
                  ...
                  <div id="gi" class="tab-pane fade">
                      ...
                      <div class="section-pannel">
                          ...
                          <div class="row">
                              <div class="col-md-6">
                                  <div class="form-group">
                                      <label>Quality System Certification:
                                          <span class="checkbox-box productalreadylabel">
                                          <input type="radio" name="startup" />No
                                          <input type="radio" class="yes" name="startup" />Yes
                                      </span>
                  ...
                  <div id="pro" class="tab-pane fade">
                      <div class="section-pannel">
                          <div class="row">
                              <div class="col-md-12">
                                  <div class="form-group live-status-box">
                                      <label>Wehther holds Defense Industry License
                                      <span class="checkbox-box productalreadylabel">
                  ...
                  <div id="spez" class="tab-pane fade">
                      <div class="section-pannel">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><input type="checkbox">Mechanical</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><input type="checkbox">Chemical</label>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
