            ...
            <div class="content oem-content">
                <div class="sideBg">
                    ...
                    <div class="text-center">
                        <asp:RadioButtonList ID="rbliststatus" runat="server" AutoPostBack="true" RepeatDirection="Horizontal" RepeatLayout="Flow" RepeatColumns="3">
                            <asp:ListItem Selected="True" Value="0">Available for verified</asp:ListItem>
                            <asp:ListItem Value="1" style="margin-left: 10px;">Approved</asp:ListItem>
                            <asp:ListItem Value="2" style="margin-left: 10px;">Disapproved</asp:ListItem>
                        </asp:RadioButtonList>
                    </div>
                    <div class="clearfix mt10"></div>
                    <div class="addfdi">
                                    ...
                                    <div class="col-md-12">
                                        <div class="faq-secion product-view">
                                            <div class="accordion" id="accordion">
                                                ...
                                                <div id="Div1" class="card" runat="server" visible="false">
                                                    <div class="card-header">
                                                ...
                                                <div id="Div2" class="card" runat="server" visible="false">
                                                    <div class="card-header">
