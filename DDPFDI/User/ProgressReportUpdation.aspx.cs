...
public partial class User_ProgressReportUpdation : System.Web.UI.Page
{
    #region Pagevariable
    Logic Lo = new Logic();
        ...
        if (Session["Type"] != null || Session["User"] != null)
            ...
            if (!IsPostBack)
            {
                ...
                //if (Encrypt.DecryptData(Session["User"].ToString()).ToLower() == "testlink@test.com")
                {
                    try
                    {
                        hidType.Value = Encrypt.DecryptData(Session["Type"].ToString());
                    ...
                    catch (Exception ex)
                    {
                        ...
                        Response.Redirect("Error?techerror=" + Encrypt.EncryptData(error) + "&page=" + Encrypt.EncryptData(Page));
                    }
                }
                else
                {
    ...
    {
        DataTable MasterFinancialYear = Lo.RetriveMasterSubCategoryDate(0, "", "", "AllFinancialYear1", "", "");
    ...
    protected void BindProduct()
    {
        ...
        DtGrid = Lo.RetriveFilterCode(Session["CompanyRefNo"].ToString(), Encrypt.DecryptData(Session["Type"].ToString()), "GetProgressData1");
    ...
    protected void BindEOIArchive()
    {

        DtGrid = Lo.RetriveFilterCode(Session["CompanyRefNo"].ToString(), "", "EOIArchive");
        if (DtGrid.Rows.Count > 0)
        {
            Session["PDatatTable"] = DtGrid;
            SeachResult();
    ...
    {
        DtGrid = Lo.RetriveFilterCodeupdate("", "", "", "", "EOIProgressData");
        if (DtGrid.Rows.Count > 0)
        {
            UpdateDtGridValue();
            Session["PDatatTable"] = DtGrid;
    ...
    protected string Dvinsert(string sortExpression = null)
    {
        ...
        if (ddlyearofindiginization.SelectedItem.Text != "Select")
        {
            ...
            dr["Value"] = "'" + ddlyearofindiginization.SelectedItem.Text + "'";
            insert.Rows.Add(dr);
        }
        ...
        else if (CheckEOIClick.Value == "Yes")
        {
            dr = insert.NewRow();
            dr["Column"] = "EOIStatus =";
            dr["Value"] = "'Archive' and Total <> 0";
            insert.Rows.Add(dr);
        }
        else if (CheckSupplyClick.Value == "Yes")
        {
            dr = insert.NewRow();
            dr["Column"] = "SupplyOrderStatus =";
            dr["Value"] = "'Yes' and EOIStatus = 'Yes'";
            insert.Rows.Add(dr);
        }
        else if (CheckSuccessClick.Value == "Yes")
        {
            dr = insert.NewRow();
            dr["Column"] = "IsIndeginized =";
            dr["Value"] = "'Y' and EOIStatus='Yes' and SupplyOrderStatus='Yes'";
            insert.Rows.Add(dr);
        }
        ...
        if (txtsearch.Text.Trim() != "")
        {
            ...
            dr["Value"] = "'" + txtsearch.Text.Trim() + "%') or (CompanyName like '" + txtsearch.Text.Trim() + "%') or (UnitName like '" + txtsearch.Text.Trim() + "%') or (FactoryName like '" + txtsearch.Text.Trim() + "%') or (NSCCode like '" + txtsearch.Text.Trim() + "%') or (ProductDescription like '" + txtsearch.Text.Trim() + "%') or (EOIStatus like '" + txtsearch.Text.Trim() + "%') or (SupplyOrderStatus like '" + txtsearch.Text.Trim() + "%') or (IsIndeginized like '" + txtsearch.Text.Trim() + "%'))";
            insert.Rows.Add(dr);
        }
    ...
    protected void gvProgress_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            Label lblstatus = (Label)e.Row.FindControl("lblintstatus2");
            ...
            LinkButton lbstartdate = (LinkButton)e.Row.FindControl("lnkeoistartdate");
            LinkButton lbenddate = (LinkButton)e.Row.FindControl("lnkeoienddate");
            //if (lblint1.Text == lblstatus.Text)
            //{
            //    lblstatus.Text = "Yes";
            //}
            //else
            ...
            //    lblstatus.Text = "No"; 
            //}
            if ((lbstartdate.Text == "01-jan-1990") || (lbstartdate.Text == ""))
            {
                lbstartdate.Text = "NA";
            }
            if ((lbenddate.Text == "01-jan-1990") || (lbenddate.Text == ""))
            {
                lbenddate.Text = "NA";
            }
    ...
    public static string[] GetSearchKeyword(string prefix)
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                ...
                cmd.CommandText = "select distinct VendorName from tbl_mst_ProgressReport where VendorName like @SearchText + '%' and (VendorName is not null or VendorName !='')";
                using (SqlDataReader sdr = cmd.ExecuteReader())
                {
                    while (sdr.Read())
                    {
                ...
                cmd.CommandText = "select distinct EOIStatus from tbl_mst_ProgressReport where EOIStatus like @SearchText + '%' ";
                using (SqlDataReader sdr = cmd.ExecuteReader())
                {
                    while (sdr.Read())
                    {
                        customers.Add(string.Format("{0}", sdr["EOIStatus"]));
                    }
                }
                cmd.CommandText = "select distinct SupplyOrderStatus from tbl_mst_ProgressReport where SupplyOrderStatus like @SearchText + '%' ";
                using (SqlDataReader sdr = cmd.ExecuteReader())
                {
                    while (sdr.Read())
                    {
                        customers.Add(string.Format("{0}", sdr["SupplyOrderStatus"]));
                    }
                }
                cmd.CommandText = "select distinct IsIndeginized from tbl_mst_ProgressReport where IsIndeginized like @SearchText + '%' ";
                using (SqlDataReader sdr = cmd.ExecuteReader())
                {
                    while (sdr.Read())
                    {
    ...
    {
        User_ProgressReportUpdation u = new User_ProgressReportUpdation();
    ...
    protected void lblProducts_Click(object sender, EventArgs e)
    {
        ...
        eoifilters.Visible = false;
        txtsearch.Text = "";
        pagingCurrentPage = 0;
        SeachResult();
        Response.Redirect("TestSimiler");
    }
    int countprod;
    protected void lblInterest_Click(object sender, EventArgs e)
    {
        ...
        //lbltotother.Text = "Total Product : " + lblProducts.Text;
        eoifilters.Visible = false;
        gvProgress.Columns[7].Visible = false;
        gvProgress.Columns[8].Visible = false;
        gvProgress.Columns[9].Visible = false;
        gvProgress.Columns[10].Visible = true;
        gvProgress.Columns[11].Visible = true;
        gvProgress.Columns[12].Visible = true;
        gvProgress.Columns[13].Visible = true;
        gvProgress.Columns[14].Visible = true;
        gvProgress.Columns[15].Visible = true;
        gvProgress.Columns[16].Visible = false;
        gvProgress.Columns[17].Visible = false;
        gvProgress.Columns[18].Visible = false;
        gvProgress.Columns[19].Visible = false;
        gvProgress.Columns[20].Visible = false;
        gvProgress.Columns[21].Visible = false;
        gvProgress.Columns[22].Visible = false;
        gvProgress.Columns[23].Visible = false;
        gvProgress.Columns[24].Visible = false;
        gvProgress.Columns[25].Visible = false;
        gvProgress.Columns[26].Visible = false;
        gvProgress.Columns[27].Visible = false;
        gvProgress.Columns[28].Visible = false;
        gvProgress.Columns[29].Visible = false;
        gvProgress.Columns[30].Visible = false;
        gvProgress.Columns[31].Visible = false;
        gvProgress.Columns[32].Visible = false;
        txtsearch.Text = "";
        pagingCurrentPage = 0;
        SeachResult();
    }
    protected void lblEOIRFP_Click(object sender, EventArgs e)
    {
        ...
        CheckProductsClick.Value = "";
        divbox.Visible = false;
        eoifilters.Visible = true;
        ddlcompany.Visible = true;
        lblNoOfProducts.Enabled = false;
        searchResultLabel.Visible = false;
        gvProgress.Columns[7].Visible = true;
        gvProgress.Columns[8].Visible = true;
        gvProgress.Columns[9].Visible = true;
        gvProgress.Columns[10].Visible = false;
        gvProgress.Columns[11].Visible = false;
        gvProgress.Columns[12].Visible = false;
        gvProgress.Columns[13].Visible = false;
        gvProgress.Columns[14].Visible = false;
        gvProgress.Columns[15].Visible = false;
        gvProgress.Columns[16].Visible = false;
        gvProgress.Columns[17].Visible = false;
        gvProgress.Columns[18].Visible = false;
        gvProgress.Columns[19].Visible = false;
        gvProgress.Columns[20].Visible = true;
        gvProgress.Columns[21].Visible = true;
        gvProgress.Columns[22].Visible = true;
        gvProgress.Columns[23].Visible = false;
        gvProgress.Columns[24].Visible = false;
        gvProgress.Columns[25].Visible = false;
        gvProgress.Columns[26].Visible = false;
        gvProgress.Columns[27].Visible = false;
        gvProgress.Columns[28].Visible = true;
        gvProgress.Columns[29].Visible = true;
        gvProgress.Columns[30].Visible = true;
        gvProgress.Columns[31].Visible = false;
        gvProgress.Columns[32].Visible = false;
        txtsearch.Text = "";
        pagingCurrentPage = 0;
            ...
            if (mIntrest.Rows.Count > 0)
            {
                ...
                if (dtnew.Rows.Count > 0)
                {
                    ...
                    if (dtads.Rows.Count > 0)
                    {
                        ...
                        Label3.Text = dtinner.Rows.Count.ToString();
                        divcontentproduct.Visible = true;
                        int[] iColumns = { 2, 4, 5, 0, 7, 8, 9, 11, 12, 14, 16, 17, 18, 19, 25, 26 };
                        RKLib.ExportData.Export objExport = new RKLib.ExportData.Export("Web");
                        objExport.ExportDetails(dtinner, iColumns, RKLib.ExportData.Export.ExportFormat.Excel, "ProgressReportList.xls");
                    }
                    else
                    {
                        ScriptManager.RegisterStartupScript(Page, Page.GetType(), "alert", "alert('No Record Found')", true);
    ...
    protected void btnUpdate_Click(object sender, EventArgs e)
    {
        if (lblstartdate.Text != "" && lblenddate.Text != "" && mhylink.Text != "")
        {
            ...
            Lo.updateeoi(hfprorefno.Value.TrimEnd(','), rbeoimake2.SelectedValue.TrimEnd(','), lblstartdate.Text.TrimEnd(','), lblenddate.Text.TrimEnd(','), mhylink.Text.TrimEnd(','));
            ScriptManager.RegisterStartupScript(this, this.GetType(), "alert", "alert('Updated Successfully!!!');window.location ='TestSimiler';", true);
            ...
            foreach (GridViewRow row in grdintshown.Rows)
            {
                if (row.RowType == DataControlRowType.DataRow)
                {
                    ...
                    if ((chk1.Checked && ddlvalue1.SelectedItem.Text != "Select"))
                    {
                        try
                        {
                            Lo.updateintshownstatus(hpref1.Text, lrequestid.Text, ddlvalue1.SelectedValue.ToString(), txtreas.Text, ddlstatus.SelectedValue.ToString());
        ...
        foreach (GridViewRow row in GridView1.Rows)
        {
            if (row.RowType == DataControlRowType.DataRow)
            {
                ...
                else if (ddlstatus1.SelectedItem.Value == "7")
                {
                    ...
                    ddlreason1.Items.Add("Indigenized");
                    //ddlreason1.Items.Add("Any other reason");
                }
    ...
    protected void lblsupply_Click(object sender, EventArgs e)
    {
        CheckEOIClick.Value = "";
        CheckIntrestClick.Value = "";
        CheckInHouse.Value = "";
        CheckProductsClick.Value = "";
        CheckSupplyClick.Value = "Yes";
        divbox.Visible = false;
        ddlcompany.Visible = true;
        eoifilters.Visible = true;
        lblNoOfProducts.Enabled = false;
        ...
        gvProgress.Columns[21].Visible = false;
        gvProgress.Columns[22].Visible = false;
        gvProgress.Columns[23].Visible = true;
        gvProgress.Columns[24].Visible = true;
        gvProgress.Columns[25].Visible = true;
        gvProgress.Columns[26].Visible = true;
        gvProgress.Columns[27].Visible = true;
        gvProgress.Columns[28].Visible = false;
        gvProgress.Columns[29].Visible = false;
        gvProgress.Columns[30].Visible = false;
        gvProgress.Columns[31].Visible = true;
        gvProgress.Columns[32].Visible = false;
        txtsearch.Text = "";
        pagingCurrentPage = 0;
        SeachResult();
    ...
    protected void lblindiginized_Click(object sender, EventArgs e)
    {
        CheckEOIClick.Value = "";
        CheckIntrestClick.Value = "";
        CheckInHouse.Value = "";
        CheckProductsClick.Value = "";
        CheckSupplyClick.Value = "";
        CheckSuccessClick.Value = "Yes";
        divbox.Visible = false;
        eoifilters.Visible = true;
        // ddlcompany.SelectedItem.Text = "Select";
        lblNoOfProducts.Enabled = false;
        searchResultLabel.Visible = false;
        divInfo.Visible = false;
        gvProgress.Columns[7].Visible = false;
        ...
        gvProgress.Columns[14].Visible = false;
        gvProgress.Columns[15].Visible = false;
        gvProgress.Columns[16].Visible = true;
        gvProgress.Columns[17].Visible = true;
        gvProgress.Columns[18].Visible = true;
        gvProgress.Columns[19].Visible = true;
        gvProgress.Columns[20].Visible = true;
        gvProgress.Columns[21].Visible = false;
        gvProgress.Columns[22].Visible = false;
        gvProgress.Columns[23].Visible = false;
        ...
        gvProgress.Columns[30].Visible = false;
        gvProgress.Columns[31].Visible = false;
        gvProgress.Columns[32].Visible = true;
        //BindCompany();
        txtsearch.Text = "";
        pagingCurrentPage = 0;
        SeachResult();
    ...
    protected void ddlyearofindiginization_SelectedIndexChanged(object sender, EventArgs e)
    {
        SeachResult();
    }
    ...
    protected void lnknil_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ScriptManager.RegisterStartupScript(this, GetType(), "nil", "showPopup19();", true);
        }
        catch (Exception ex)
        {
            //success.Visible = false;
