            ...
            <div class="modal-content">
                <div class="modal-header">
                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                        <li class="nav-item"><a class="nav-link active" href="#" data-toggle="tab" role="tab" aria-selected="true">About us</a></li>
                    </ul>
    ...
    <div class="modal fade" id="contact_us_modal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 600px;">
            <div class="modal-content">
                <div class="modal-header">
                    <ul class="nav nav-tabs card-header-tabs" role="tablist">
                        <li class="nav-item"><a class="nav-link active" href="#" data-toggle="tab" role="tab" aria-selected="true">Contact us</a></li>
                    </ul>
                    <button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body tab-content py-4">
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <ul class="list-unstyled font-size-sm mb-0">
                                        <p class="font-size-sm text-muted">Example adress here</p>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-grid-gutter">
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <ul class="list-unstyled font-size-sm mb-0">
                                        <li><span class="text-muted mr-1">For customers:</span><a class="nav-link-style" href="#">+91xxxxxxxxxx</a></li>
