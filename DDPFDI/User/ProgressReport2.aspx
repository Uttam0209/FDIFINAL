<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ProgressReport2.aspx.cs" Inherits="User_ProgressReport2" MasterPageFile="~/User/MasterPage.master" %>

<asp:Content runat="server" ID="content1" ContentPlaceHolderID="head">
    <%--  <link rel="stylesheet" type="text/css" href="User/Uassets/css/jquery.dataTables.min.css" />
    <link href="../User/Uassets/css/jquery-ui.css" rel="stylesheet" />
...
<asp:Content runat="server" ID="content2" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                ...
                <div class="col-lg-11">
                    <div class="row d-flex">
                        <div class="col-12 d-flex justify-content-end py-3">
                            ...
                            <asp:HiddenField runat="server" ID="Checkunabcontvend" />
                        </div>
                        <div class="col-10">
                            ...
                            <ul class="nav nav-tabs" style="border-bottom: none;">
                                <li class="nav-item my-0 py-0" style="width: 130px; background: rgb(0, 102, 153); color: white; font-weight: bold; text-align: center;">Products                                                                      
                                    ...
                                    <asp:Label runat="server" ID="lblProducts" ForeColor="White" ToolTip="Products no : Shows total no of Product" data-toggle="tooltip" OnClick="lblProducts_Click"></asp:Label>
                                </li>
                             ...
                             <div class="dropdown-divider"></div>
                                    <asp:LinkButton runat="server" ID="lblInterest" ForeColor="White" OnClick="lblInterest_Click" data-toggle="tooltip" ToolTip="Total Intrest no.: No. of Products on which Intrest shown"></asp:LinkButton>
                                    &nbsp
                                ...
                                <li class="nav-item my-0 py-0" style="width: 150px; background: #00CC66; color: white; font-weight: bold; text-align: center;">EOI/RFP Status
                                    ...
                                    <div class="dropdown-divider"></div>
                                    <asp:LinkButton runat="server" ID="lblEOIRFP" ForeColor="White"  data-toggle="tooltip" ToolTip="EOI no. : Products on which
                                        EOI status is updated "></asp:LinkButton>
                            ...
                            <div class="dropdown-divider"></div>
                                    <asp:Label runat="server" ID="lblsupply" ForeColor="White" data-toggle="tooltip" ToolTip="Supply Order no.: Products on which Supply Order is Available "></asp:Label>
                                ...
                                <li class="nav-item my-0 py-0" style="width: 130px; background: #004D28; color: white; font-weight: bold; text-align: center;">Success Story
                                    <div class="dropdown-divider"></div>
                                    <asp:Label runat="server" ID="lblindiginized" ForeColor="White" data-toggle="tooltip" ToolTip="Success Story no. : Products on which Indigenisation status is Yes"></asp:Label>
                                    &nbsp(<asp:Label runat="server" ID="lblIndiPerc" Text=""></asp:Label>%)
                                </li>
                            </ul>
                        </div>
                        <div class="col-2 d-flex justify-content-end" >
                            <asp:LinkButton runat="server" ID="lbproddetail" Visible="false" ToolTip="Brief Details of Products " data-toggle="tooltip" OnClick="lbproddetail_Click"><i class="fa fa-eye"></i>&nbsp;More Details</asp:LinkButton>
                        </div>
                                ...
                                <thead>
                                    <tr id="tabcolrchng" runat="server" style="padding: 0PX;">
                                        ...
                                        <th id="th1" runat="server" visible="false">
                                            <asp:Label ID="lbltotother" runat="server" ForeColor="White" OnClick="lbltotother_Click" Text=""></asp:Label>
                                        </th>
                                        <th>
                                            <asp:LinkButton ID="lblNoOfProducts" runat="server" ForeColor="White" data-toggle="tooltip" ToolTip="Clicking here, the user can see to take action on Total Interested Product: Vendors" OnClick="lblNoOfProducts_Click" Text=""></asp:LinkButton>
                                        </th>
                                        <th>
                                            <asp:Label ID="lbltotalintrestshowprod" runat="server" ForeColor="White" OnClick="lbltotalintrestshowprod_Click" Text=""></asp:Label>
                                        </th>
                            ...
                            <div class="table-responsive text-center">
                                <table class="table table-bordered" style="background: #999966;">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="lnknil" runat="server" ForeColor="White" ToolTip="By clicking here, the users see, how many vendors did not take any action on the interested product.:" data-toggle="tooltip" OnClick="lnknil_Click"></asp:LinkButton>
                                            </td>
                                            <td>
                                                <asp:LinkButton ID="lnkunbconvend" runat="server" ForeColor="White" data-toggle="tooltip" ToolTip="By clicking here, the users see, how many vendors are not available, then for contact vendor action on the interested product." OnClick="lnkunbconvend_Click"></asp:LinkButton>
                                            </td>
                                            <td>
                                                <asp:LinkButton ID="lnkresawait" runat="server" ForeColor="White" data-toggle="tooltip" ToolTip="By clicking here, the users see, how many vendors are response awaited action on the interested product." OnClick="lnkresawait_Click"></asp:LinkButton>
                                            </td>
                                            <td>
                                                <asp:LinkButton ID="lnkrespeval" runat="server" ForeColor="White" data-toggle="tooltip" ToolTip="By clicking here, the users see, how many vendors are response under evaluation action on the interested product." OnClick="lnkrespeval_Click"></asp:LinkButton>
                                            </td>
                                            <td>
                                                <asp:LinkButton ID="lnkvendnotfit" runat="server" ForeColor="White" data-toggle="tooltip" ToolTip="By Clicking here, the users see ,how many vendors are vendors not qualified on the interested product." OnClick="lnkvendnotfit_Click"></asp:LinkButton>
                                            </td>
                                            <td>
                                                <asp:LinkButton ID="lnkvendfit" runat="server" ForeColor="White" data-toggle="tooltip" ToolTip="By Clicking here, the users see ,how many vendors are vendors qualified on the interested product." OnClick="lnkvendfit_Click"></asp:LinkButton>
                                            </td>

                                            <td>
                                                <asp:LinkButton ID="lnkitemnotreq" runat="server" ForeColor="White" data-toggle="tooltip" ToolTip="By clicking here, the users are see, how many vendors do not take the items not required action on the interesting product." OnClick="lnkitemnotreq_Click"></asp:LinkButton>
                                            </td>
                                            <td>
                                                <asp:LinkButton ID="lnkindUproc" runat="server" ForeColor="White" data-toggle="tooltip" ToolTip="By clicking here, the users see, how many vendors do not indigenize under-process on the interesting product and other vendors take action" OnClick="lnkindUproc_Click"></asp:LinkButton>
                                            </td>
                                            <td>
                                                <asp:LinkButton ID="lnkeoidone" runat="server" ForeColor="White" data-toggle="tooltip" ToolTip="By clicking here, the users see, how many vendors did not take the vendor action, supply order and indigenized on the interested product." OnClick="lnkeoidone_Click"></asp:LinkButton>
                                            </td>
                    ...
                    <div class="row d-flex justify-content-between">
                        <div class="col-sm-3 mb-sm-0 mb-2 d-flex">
                            <asp:LinkButton runat="server" ID="btnExcel" CssClass="btn" data-toggle="tooltip" ToolTip="To download the details of Product in excel sheet press the excel button." Style="background: #6915cf!important; margin-right: 5px!important; color: #fff;" OnClick="btnExcel_Click">Excel</asp:LinkButton>
                            <asp:TextBox ID="txtgosearch" runat="server" data-toggle="tooltip" ToolTip="Enter the Page no. to visit" Style="max-height: 45px; max-width: 100px;" CssClass="form-control appended-form-control" AutoCompleteType="Search" Placeholder="Page No."></asp:TextBox>
                            <asp:LinkButton ID="btngoto" runat="server" CssClass="btn" data-toggle="tooltip" ToolTip="User Can go to the direct page" Style="background: #6915cf!important; color: #fff;" OnClick="btngosearch_Click">Go to</asp:LinkButton>
                        </div>
                        <div class="col-sm-9 d-flex justify-content-end">
                            <asp:TextBox ID="txtsearch" runat="server" Style="max-height: 45px; max-width: 420px;"
                                ToolTip="Enter the key word you want to search here." onblur="SaveData('txtsearch')" OnTextChanged="txtsearch_TextChanged" CssClass="form-control appended-form-control"
                                Placeholder="Search (type min three character)"></asp:TextBox>
                            <asp:Button runat="server" ID="btnsearch" Style="background: #6915cf!important; color: #fff;" data-toggle="tooltip" ToolTip="user can search through the product ref no , item name, company name ,NSC Code,Yes ,No" CssClass="btn" Text="Search" OnClick="btnsearch_Click" />
                        </div>
                                ...
                                <asp:GridView runat="server" ID="gvProgress" Width="100%" Class="table table-hover table-bordered" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Date" HeaderStyle-Width="150px">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lbldate" data-toggle="tooltip" ToolTip="interest shown date by the vendor " Text='<%#Eval("VendorDate","{0: dd-MMM-yyyy}") %>'>                                                       
                                                </asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Company" HeaderStyle-Width="150px">
                                            <ItemTemplate>
                                                <asp:Label runat="server" ID="lblcompshow" ToolTip='<%#Eval("CompanyName") %>' Text='<%#Eval("CompanyName") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Division/Unit" HeaderStyle-Width="150px">
                                            <ItemTemplate>
                                                <asp:Label ID="lbldivsion" runat="server" data-toggle="tooltip" ToolTip="It's Shown division name" Text='<%# Eval("FactoryName") %>'>
                                                </asp:Label>
                                                <asp:Label ID="lblunit" runat="server" data-toggle="tooltip" ToolTip="It's Shown Unit Name" Text='<%# Eval("UnitName") %>'>
                                                </asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <asp:TemplateField HeaderText="No. Of Interest" HeaderStyle-Width="120px">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lblinterest" runat="server" data-toggle="tooltip" ToolTip="No. of Interest recieved on Products" CommandArgument='<%#Eval("ProductRefNo") %>' CommandName="totalintstatus" Text='<%# Eval("Total")%>'>
                                                </asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Action initiated" HeaderStyle-ForeColor="#333333" HeaderStyle-Width="200px">
                                            ...
                                            <ItemTemplate>
                                                <table style="width: 100%">
                                                    <tr>
                                                        <td colspan="3">
                                                            <asp:LinkButton runat="server" ID="lblintstatus" data-toggle="tooltip" ToolTip="Click here for Update Reason Status" CommandArgument='<%#Eval("ProductRefNo") %>' CommandName="Status" Text='<%# Eval("IntYes")%>'></asp:LinkButton>
                                                        </td>
                                                        <td colspan="3">
                                                            <asp:LinkButton runat="server" ID="lblintstatus1" data-toggle="tooltip" ToolTip="Click here for Reason Update" CommandArgument='<%#Eval("ProductRefNo") %>' CommandName="Status1" Text='<%# Eval("IntNo")%>'></asp:LinkButton>
                                                        </td>
                                                    </tr>
                                                </table>
                                        ...
                                        <asp:TemplateField HeaderText="EOI" HeaderStyle-Width="100px">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="EOI" data-toggle="tooltip" ToolTip="Click here for update EOI Details:" CommandArgument='<%#Eval("ProductRefNo") %>' CommandName="EOI" Text='<%#Eval("EOIStatus") %>'></asp:LinkButton>
                                        ...
                                        <asp:TemplateField HeaderText="Supply Order" HeaderStyle-Width="200px">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="mSupplyorder" data-toggle="tooltip" ToolTip="Click here for Update Supply Order Details.." CommandArgument='<%#Eval("ProductRefNo") %>' CommandName="SupplyOrd" Text='<%#Eval("SupplyOrderStatus") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Success Story" HeaderStyle-Width="200px">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="successstory" data-toggle="tooltip" ToolTip="Click for update Success Story Details .." CommandArgument='<%#Eval("ProductRefNo") %>' CommandName="Success_story" Text='<%#Eval("IsIndeginized") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <%--  <asp:TemplateField HeaderText="SupplyManfutureName" HeaderStyle-Width="200px" Visible="false">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="lnksuppmaname"  Text='<%#Eval("SupplyManfutureName") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                         <asp:TemplateField HeaderText="SupplyManfutureAddress" Visible="false">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="lnksuppaddr"  Text='<%#Eval("SupplyManfutureAddress") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>  
                                         <asp:TemplateField HeaderText="Supplyordervalue" Visible="false">
                                            <ItemTemplate>
                                                <asp:LinkButton runat="server" ID="lnksuppordval"  Text='<%#Eval("SupplyOrderValue") %>'></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField> 
                                           <asp:TemplateField HeaderText="Supplyordervalue" Visible="false">
                                            <ItemTemplate>
                                        ...
                                        <asp:BoundField DataField="Make2cat" HeaderText="Make-II Category" />
                                        <asp:BoundField DataField="TopReasone" HeaderText="Interest Reason" />
                                    </Columns>
            ...
            <div class="modal-quick-view modal fade" id="ProductCompany1" tabindex="-1">
                <div class="modal-dialog modal-xl" style="max-width: 1000px!important; z-index: 9999999999;">
                    <div class="modal-content">
                        ...
                        <div>
                            <h6 class="modal-title text-Red" style="font-family: Arial; font-size: medium; color: red; font: bold; margin-top: 3%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Remark: The total value has been arrived by taking into date of previous 3years & the current year 2021-22.</h6>
                        </div>
                        <div class="modal-body" style="padding: 20px 40px 18px 40px;" id="printarea">
                            <asp:GridView runat="server" ID="gvhover" Class="table table-striped table-bordered overflow-auto" OnRowDataBound="gvhover_RowDataBound" Width="100%" AutoGenerateColumns="false" CellPadding="4"
                                ...
                                <Columns>
                                    ...
                                    <%--<asp:TemplateField HeaderText="EOI/RFp Status" Visible="false" HeaderStyle-CssClass=" d-none">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lbleoirfp" Text='<%#Eval("EoiProductIntrest") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>
                                    <asp:BoundField DataField="eoistatus" HeaderText="Total EOI/RFP" Visible="false" />
                                    <%--<asp:TemplateField HeaderText="Total EOI/RFP" Visible="false" HeaderStyle-CssClass=" d-none">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lbltotaleoi" Text='<%#Eval("eoistatus") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>
                                    <asp:BoundField DataField="supplyorder" HeaderText="Total Supply-Order" Visible="false" />
                                    <%--<asp:TemplateField HeaderText="Total Supply-Order" Visible="false" HeaderStyle-CssClass=" d-none">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblsuppord" Text='<%#Eval("supplyorder") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>
                                    <asp:BoundField DataField="Indiginized" HeaderText="Total Indiginized" Visible="false" />
                                    <%--<asp:TemplateField HeaderText="Total Indiginized" Visible="false" HeaderStyle-CssClass=" d-none">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lblttlindig" Text='<%#Eval("Indiginized") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>
                                    ...
                                    <asp:TemplateField HeaderText="EOI done/SO Placed/Indigenized" Visible="false">
                                        <ItemTemplate>
                                            <asp:Label runat="server" ID="lbleoisoplaced"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                        ...
                        <div class="modal-footer" style="padding-top: 0px!important;">
                            <input id="btnprint" type="button" runat="server" onclick="PrintDiv()" style="width: 70px; background: #507CD1!important;" class="btn btn-primary"
                                value="Print" />
                            <asp:LinkButton ID="LinkButton3" runat="server" Text="Close" Style="background: #507CD1!important;" class="btn btn-primary"
                ...
                <div class="modal-dialog  modal-xl" style="max-width: 400px!important; z-index: 9999999999;">
                    <div class="modal-content">
                        <div runat="server" id="Div17">
                            <div class="modal-header modal-header1 d-flex justify-content-center" style="background: #507CD1!important;">
                                <h6 class="modal-title text-white">Status</h6>
                            ...
                            <div class="modal-body" style="text-align: center;">
                                ...
                                <table style="position: center;" class="table table-responsive">
                                    ...
                                    <tr>
                                        <td />
                                        <td class="d-flex justify-content-end">
                                            <asp:LinkButton ID="LinkButton5" runat="server" Text="Update" Style="background: #507CD1!important;" class="btn btn-primary mr-2"
                                                ClientIDMode="Static" OnClick="lnkupatesuccess_Click" ToolTip="Update Data"><i class="fa fa-edit"></i>&nbsp;Update</asp:LinkButton>
                                            <asp:LinkButton ID="LinkButton7" runat="server" Text="Close" Style="background: #507CD1!important;" class="btn btn-primary"
                                                ClientIDMode="Static" data-dismiss="modal" />
                                        </td>
                                    </tr>
                                </table>
                ...
                <div class="modal-dialog  modal-xl" style="max-width: 1367px  !important; z-index: 9999999999;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body overflow-auto">
                            <p class="pull-right mr-1" runat="server" id="P8"></p>
                            <div class="clearfix"></div>
            ...
            <div class="modal-quick-view modal fade" id="unabcontvendor" role="dialog">
                <div class="modal-dialog  modal-xl" style="width: 930px!important; z-index: 9999999999;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body overflow-auto">
                            <p class="pull-right mr-1" runat="server" id="P7"></p>
                            <div class="clearfix"></div>
                        ...
                        <div class="modal-footer">
                            <asp:LinkButton runat="server" ID="LinkButton17" CssClass="btn btn-primary" Style="margin-right: 5px!important; background: #507CD1!important;" OnClick="LinkButton17_Click">Excel</asp:LinkButton>
            ...
            <div class="modal-quick-view modal fade" id="reqnotneeded" role="dialog">
                <div class="modal-dialog  modal-xl" style="width: 930px!important; z-index: 9999999999;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body overflow-auto">
                            <p class="pull-right mr-1" runat="server" id="lblcountgridtotal"></p>
                            <div class="clearfix"></div>
                        ...
                        <div class="modal-footer">
                            <asp:LinkButton runat="server" ID="LinkButton16" CssClass="btn btn-primary" Style="margin-right: 5px!important; background: #507CD1!important;" OnClick="LinkButton16_Click">Excel</asp:LinkButton>
            ...
            <div class="modal-quick-view modal fade" id="underprocess" role="dialog">
                <div class="modal-dialog  modal-xl" style="width: 950px!important; z-index: 9999999999;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body overflow-auto">
                            <p class="pull-right mr-1" runat="server" id="P1"></p>
                            <div class="clearfix"></div>
                            ...
                            <div class="modal-footer">
                                <asp:LinkButton runat="server" ID="LinkButton15" CssClass="btn btn-primary" Style="margin-right: 5px!important; background: #507CD1!important;" OnClick="LinkButton15_Click">Excel</asp:LinkButton>
            ...
            <div class="modal-quick-view modal fade" id="vendorsuit" role="dialog">
                <div class="modal-dialog  modal-xl" style="width: 950px!important; z-index: 9999999999;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body overflow-auto">
                            <p class="pull-right mr-1" runat="server" id="P2"></p>
                            <div class="clearfix"></div>
                            ...
                            <div class="modal-footer">
                                <asp:LinkButton runat="server" ID="LinkButton14" CssClass="btn btn-primary" Style="margin-right: 5px!important; background: #507CD1!important;" OnClick="LinkButton14_Click">Excel</asp:LinkButton>
            ...
            <div class="modal-quick-view modal fade" id="eoi" role="dialog">
                <div class="modal-dialog  modal-xl" style="max-width: 950px!important; z-index: 9999999999;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body overflow-auto">
                            <p class="pull-right mr-1" runat="server" id="P3"></p>
                            <div class="clearfix"></div>
                            ...
                            <div class="modal-footer">
                                <asp:LinkButton runat="server" ID="LinkButton13" CssClass="btn btn-primary" Style="margin-right: 5px!important; background: #507CD1!important;" OnClick="LinkButton13_Click">Excel</asp:LinkButton>
            ...
            <div class="modal-quick-view modal fade" id="other_action" role="dialog">
                <div class="modal-dialog  modal-xl" style="max-width: 950px!important; z-index: 9999999999;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body overflow-auto">
                            <p class="pull-right mr-1" runat="server" id="P4"></p>
                            <div class="clearfix"></div>
                            <asp:GridView ID="GridView6" runat="server" AutoGenerateColumns="false"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="IntShownReason" HeaderText="Interest Shown" HeaderStyle-Width="100px" NullDisplayText="NA" />
                                    <asp:BoundField DataField="VendorName" HeaderText="Vendor Name" HeaderStyle-Width="100px" />
                                </Columns>
                            </asp:GridView>
                            <div class="modal-footer">
                                <asp:LinkButton runat="server" ID="LinkButton12" CssClass="btn btn-primary" Style="margin-right: 5px!important; background: #507CD1!important;" OnClick="LinkButton12_Click">Excel</asp:LinkButton>
            ...
            <div class="modal-quick-view modal fade" id="reqdoesnotexist" role="dialog">
                <div class="modal-dialog  modal-xl" style="width: 950px!important; z-index: 9999999999;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body overflow-auto">
                            <p class="pull-right mr-1" runat="server" id="P5"></p>
                            <div class="clearfix"></div>
                            ...
                            <div class="modal-footer">
                                <asp:LinkButton runat="server" ID="LinkButton10" CssClass="btn btn-primary" Style="margin-right: 5px!important; background: #507CD1!important;" OnClick="LinkButton10_Click">Excel</asp:LinkButton>
            ...
            <div class="modal-quick-view modal fade" id="soplaced" role="dialog">
                <div class="modal-dialog  modal-xl" style="width: 950px!important; z-index: 9999999999;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body overflow-auto">
                            <p class="pull-right mr-1" runat="server" id="P6"></p>
                            <div class="clearfix"></div>
                            ...
                            <div class="modal-footer">
                                ...
                                <asp:LinkButton runat="server" ID="LinkButton11" CssClass="btn btn-primary" Style="margin-right: 5px!important; background: #507CD1!important;" OnClick="LinkButton11_Click">Excel</asp:LinkButton>
                ...
                <div class="modal-dialog  modal-xl" style="max-width: 950px!important; z-index: 9999999999;">
                    <div class="modal-content">
                        ...
                        <div class="modal-body overflow-auto">
                            ...
                            <div class="modal-footer">
                                <asp:LinkButton runat="server" ID="LinkButton18" CssClass="btn btn-primary" Style="margin-right: 5px!important; background: #507CD1!important;" OnClick="LinkButton18_Click1">Excel</asp:LinkButton>
        ...
        <Triggers>
            ...
            <asp:PostBackTrigger ControlID="LinkButton10" />
            <asp:PostBackTrigger ControlID="LinkButton18" />
        </Triggers>
    </asp:UpdatePanel>
                                        ...
                                        <asp:TemplateField HeaderText="Status">
                                            <ItemTemplate>
                                                <asp:DropDownList runat="server" ID="ddlstatus1" Text='<%#Eval("Reasonid") %>' AutoPostBack="true" Width="150px" OnSelectedIndexChanged="ddlstatus1_SelectedIndexChanged">
                                                    ...
                                                    <asp:ListItem Text="Indigenization U/Process with other vendor" Value="7"></asp:ListItem>
                                                    <asp:ListItem Text="EOI done /SO placed/Indigenized" Value="8"></asp:ListItem>
                                                    <asp:ListItem Text="Item not required" Value="6"></asp:ListItem>
                                                </asp:DropDownList>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Reason" Visible="false">
                                            <ItemTemplate>
                                                <asp:DropDownList runat="server" Visible="true" AutoPostBack="true" OnSelectedIndexChanged="ddlreason_SelectedIndexChanged" Enabled="false" ID="ddlreason" Width="150px" Style="overflow: auto;">
                                                    <asp:ListItem Text="Select" Value=""></asp:ListItem>
                                                    <asp:ListItem Text="Any other reason" Value="Any other reason"></asp:ListItem>
                                                </asp:DropDownList>
                            ...
                            <div class="modal-body overflow-auto">
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Reason" Visible="false">
                                            <ItemTemplate>
                                                <asp:DropDownList Visible="false" runat="server" Text='<%#Eval("IntShownReason") %>' ID="ddlreason" AutoPostBack="true" OnSelectedIndexChanged="ddlreason_SelectedIndexChanged1" Width="150px" Style="overflow: auto;">
                                                    <asp:ListItem Text="Select" Value=""></asp:ListItem>
                                                    <asp:ListItem Text="Any other reason" Value="Any other reason"></asp:ListItem>
                                                </asp:DropDownList>
                                                <asp:TextBox runat="server" Visible="false" ID="TxtBxDesc" Text='<%#Eval("UserReason") %>' TextMode="MultiLine" Rows="5" class="form-control" placeholder="Type Your Reason" required></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
        ...
        function SetAutoComplete() {
            $("[id$=txtsearch]").autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: 'User/ProgressReport2.aspx/GetSearchKeyword',
