                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <div>L1 :
                                    <asp:TextBox ID="txtL1" runat="server"></asp:TextBox></div>
                                <div>L2 :
                                    <asp:TextBox ID="txtL2" runat="server"></asp:TextBox></div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <asp:Button ID="btnProduct" runat="server" class="btn btn-primary btn-sm btn-block"
